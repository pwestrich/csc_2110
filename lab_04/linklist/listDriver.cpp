   ...
   { 
      ...
      else if (command == "GetItem")
      {
         ...
         PrintList(outFile, list);
           ...
           UnsortedType list1, list2; //Declare two lists
           ItemType key;
           
           inFile >> number;
           key.Initialize(number);
           
           outFile << "Printing Split Lists.." << endl;
           
           list.SplitList(key, list1, list2);//Split the list
           PrintList(outFile, list1);        //Print the list
